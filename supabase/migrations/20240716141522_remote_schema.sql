...
CREATE POLICY "All autenticatied users ALL operations" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "All autenticatied users ALL operations" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
